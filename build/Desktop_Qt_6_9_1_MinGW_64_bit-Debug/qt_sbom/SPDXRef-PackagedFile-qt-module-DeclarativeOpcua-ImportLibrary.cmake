        ...
        if(NOT EXISTS "$ENV{DESTDIR}${CMAKE_INSTALL_PREFIX}/lib/libQt6DeclarativeOpcua.a"
                AND NOT QT_SBOM_BUILD_TIME AND NOT QT_SBOM_FAKE_CHECKSUM)
            if(NOT TRUE)
                message(FATAL_ERROR "Cannot find 'lib/libQt6DeclarativeOpcua.a' to compute its checksum. "
                    "Expected to find it at '$ENV{DESTDIR}${CMAKE_INSTALL_PREFIX}/lib/libQt6DeclarativeOpcua.a' ")
            endif()
        else()
            if(NOT QT_SBOM_BUILD_TIME)
                if(QT_SBOM_FAKE_CHECKSUM)
                    ...
                    file(SHA1 "$ENV{DESTDIR}${CMAKE_INSTALL_PREFIX}/lib/libQt6DeclarativeOpcua.a" sha1)
                endif()
...
"
FileName: ./lib/libQt6DeclarativeOpcua.a
SPDXID: SPDXRef-PackagedFile-qt-module-DeclarativeOpcua-ImportLibrary
FileType: BINARY
FileChecksum: SHA1: ${sha1}
LicenseConcluded: LicenseRef-Qt-Commercial OR LGPL-3.0-only OR GPL-2.0-only OR GPL-3.0-only
FileCopyrightText: <text>Copyright (C) The Qt Company Ltd. and other contributors.</text>
LicenseInfoInFile: NOASSERTION
Relationship: SPDXRef-Package-qtopcua-qt-module-DeclarativeOpcua CONTAINS SPDXRef-PackagedFile-qt-module-DeclarativeOpcua-ImportLibrary
Relationship: SPDXRef-PackagedFile-qt-module-DeclarativeOpcua-ImportLibrary GENERATED_FROM NOASSERTION
